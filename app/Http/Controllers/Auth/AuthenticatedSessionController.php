...
class AuthenticatedSessionController extends Controller
{
     ...
     */
    public function store(LoginRequest $request): JsonResponse // felhasználó bejelentkezési kérelmét kezeli egy API-ban.
     ...
     */
    public function destroy(Request $request): JsonResponse //egyszerű kijelentkezési (logout) funkciót valósít meg az API-ban
    {
        $request->user()->currentAccessToken()->delete(); //Kijelentkezteti a felhasználót az aktuális hozzáférési token törlésével.
    	return response()->json(['message' => 'Logout successful'], 200); //Értesíti a klienst a kijelentkezés sikerességéről egy JSON válaszban
    }
}
